...
export function CreateGamePage({ profile, onCancel, onCreated }: Props) {
  ...
  return <main className="page page-narrow"><PageHeader eyebrow={t('newBank')} title={t('createLobby')} description={t('lobbyLede')} backAction={<button className="button button-quiet" type="button" onClick={onCancel}>{t('cancel')}</button>} />
