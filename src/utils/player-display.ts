...
export function playerNameWithGameId(player: NamedPlayer, players: readonly NamedPlayer[]): string {
...
function shortGamePlayerId(player: NamedPlayer, players: readonly NamedPlayer[]): string {
