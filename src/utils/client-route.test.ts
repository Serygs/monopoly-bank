...
describe('client routes', () => {
  ...
  it('preserves game and invitation deep-link paths for the SPA shell', () => {
    expect(routePath('/games/00000000-0000-4000-8000-000000000001')).toBe('/games/00000000-0000-4000-8000-000000000001');
    expect(currentRoute('/games/join', '?code=TABLE42', '#invite=secure-token')).toBe('/games/join?code=TABLE42#invite=secure-token');
  });
});
